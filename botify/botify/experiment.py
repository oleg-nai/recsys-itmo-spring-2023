...
class Experiments:
    ...
    UB_NN_MY_BASED = Experiment("UB_NN_MY_BASED", Split.FOUR_WAY)
    CONTEXTUAL_VS_MY = Experiment("CONTEXTUAL_VS_MY", Split.FOUR_WAY)

    def __init__(self):
        self.experiments = [Experiments.CONTEXTUAL_VS_MY]
